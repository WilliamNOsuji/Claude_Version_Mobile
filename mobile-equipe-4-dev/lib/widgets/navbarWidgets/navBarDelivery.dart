...
Widget navBarFloatingYesDelivery(
  ...
  List<Widget> navIcons = [
    Icon(Icons.home),
    badges.Badge(
      badgeContent: Text(ApiService.CartItemCount.toString(),
  ...
  List<String> navTile = ["Home", "Panier", "Livraison", "Commande", "Profil"];
                  ...
                  if (!onTheSamePage('/cartPage')) {
                    ...
                    try {
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              CartPage(CardProducts: response),
                        ),
                      );
